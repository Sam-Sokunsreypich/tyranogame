[_tb_system_call storage=system/_LV_2.ks]
...
[jump  storage="LV_2.ks"  target="*LV_2"  cond="f.var_1<f.var_2"  ]
[call  storage="img.ks"  target="*var_1"  ]
[tb_image_show  time="10"  storage="default/num_img/_.png"  width="666"  height="375"  x="-181"  y="-10"  name="img_6"  ]
[call  storage="img.ks"  target="*var_2"  ]
[tb_image_show  time="10"  storage="default/num_img/_-removebg-preview.png"  width="666"  height="375"  x="7"  y="-4"  name="img_8"  ]
[cm  ]
